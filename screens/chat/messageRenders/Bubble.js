...
export default class Bubble extends React.Component {
    ...
    renderMessageText() {
        if (this.props.currentMessage && this.props.currentMessage.text) {
            ...
            messageTextProps.onLongPress = this.onLongPress
    ...
    renderMessageImage() {
        if (this.props.currentMessage && this.props.currentMessage.image) {
            ...
            messageImageProps.onLongPress = this.onLongPress
    ...
    renderMessageVideo() {
        if (this.props.currentMessage && this.props.currentMessage.video) {
            ...
            messageVideoProps.onLongPress = this.onLongPress
    ...
    renderMessageAudio() {
        if (this.props.currentMessage && this.props.currentMessage.audio) {
            ...
            messageAudioProps.onLongPress = this.onLongPress
    ...
    renderCustomView() {
        if (this.props.renderCustomView) {
            return this.props.renderCustomView({...this.props, onLongPress: this.onLongPress});
        }
        return null;
    }
    renderBubbleContent() {
